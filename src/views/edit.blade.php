...
<ul class="nav nav-tabs" id="myTab" role="tablist">
  ...
  <li class="nav-item">
    <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Tasks ({{$tasks}})
    @if ($errors->has('edit_task_start_date') or $errors->has('edit_task_due_date')) <i class="fa fa-warning text-warning"></i>@endif
    </a>
  </li>
  <li class="nav-item">
  ...
  @if (auth::User()->tasks_add == "on")
  <li class="nav-item">
    <a class="nav-link" id="newtask-tab" data-toggle="tab" href="#newtask" role="tab" aria-controls="newtask" aria-selected="false">New Task 
    @if ($errors->has('task_start_date') or $errors->has('task_due_date')) <i class="fa fa-warning text-warning"></i>@endif 
    </a>
  </li>
  @endif
</ul>
        ...
        <div class="row">
            ...
            <div class="col-md-12 text-white">
                <h2 class="card-title">Update Project - DR-{{$p->project_ref}}</h2>
        ...
        <div class="row">
            <div class="col-md-4 text-white">
                ...
                <h5>Client</h5>
                       ...
                       @endforeach
                        ...
                        <br><br>
                        <h6>Project Reference: </h6> <p>DR- <input type="text" class="form-control col-2 bg-dark text-white" name="project_ref" value="{{$p->project_ref}}" onchange="submit()" ></p>
            ...
            <div class="col-md-4 text-white">
                        ...
                        <h6>Start Date: <input type="text" class="form-control bg-dark text-white" name="start_date" value="{{$p->start_date}}" onchange="submit()"></h6>
                                @if ($errors->has('start_date'))
                                <span class="invalid-feedback" style="display: block;" role="alert">
                                <strong>{{ $errors->first('start_date') }}</strong>
                                </span>
                                @endif
                        <h6>Due Date: <input type="text" class="form-control bg-dark text-white" name="due_date" value="{{$p->due_date}}" onchange="submit()"></h6>
            ...
            <div class="row">
                <div class="col-md-12 text-white">
                        ...
                        <h5>Project Summary</h5>
                            ...
                            <textarea class="form-control bg-dark text-white" name="project_summary" onchange="submit()">{{$p->project_summary}}</textarea>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <form action="{{ route('projects.updatetask',['id' => $task->id, 'cid' => $task->project_id]) }}" method="POST" enctype="multipart/form-data">
                                                        ...
                                                        <div class="modal-body text-dark">
                                                                    ...
                                                                    <input type="text" class="form-control col-12 bg-dark text-white" name="edit_task_summary" value="{{ $task->task_summary}}" required>
                                                                    ...
                                                                    <input type="text" class="form-control col-6 bg-dark text-white" name="edit_task_start_date" value="{{ $task->start_date }}">
                                                                    ...
                                                                    <input type="text" class="form-control col-6 bg-dark text-white" name="edit_task_due_date" value="{{ $task->due_date }}">
                                                                    ...
                                                                    <select class="form-control col-12 bg-dark text-white" name="task_percent_completed">
                                                                    ...
                                                                    <textarea class="form-control col-md-12 bg-dark text-white" name="task_details" >{{$task->task_description}}</textarea>
                                                                    </div>

                                                                    <div class="form-group">
                                                                    <label>Status</label>
                                                                    <select class="form-control col-12 bg-dark text-white" name="status">
...
<div class="row">
                <div class="col-md-12 text-white">
                        ...
                        @method('PUT')  
                          ...
                          <label>Task Summary</label>
                          <input type="text" class="form-control col-2 bg-dark text-white" name="task_summary" value="{{ old('task_summary') }}" required>
                          ...
                          <br>
                          <label>Start Date</label>
                          <input type="text" class="form-control col-2 bg-dark text-white" name="task_start_date" value="{{ old('task_start_date') }}">
                          ...
                          <br>
                          <label>Due Date</label>
                          <input type="text" class="form-control col-2 bg-dark text-white" name="task_due_date" value="{{ old('task_due_date') }}">
                          ...
                          <br>
                          <label>Percentage Completed</label>
                          <select class="form-control col-2 bg-dark text-white" name="task_percent_completed"><option value="0">0%</option>
                          <option value="5">5%</option>
                          <option value="10">10%</option>
                          <option value="25">25%</option>
                          <option value="50">50%</option>
                          ...
                          <br>
                          <label>Task Details</label>
                          <textarea class="form-control col-md-2 bg-dark text-white" name="task_details" ></textarea>


<br><br>

<input type="submit" class="btn btn-outline-success btn-md" value="Save">
